...
const defaultApiContextValue: ApiContextValue = {
    client: ky.create({}),
    config: {},
    onError: (error) => { console.error('api is error.', error) },
    onTimeout: (error) => { console.error('api is timeout.', error) },
    onUnauthorized: (error) => { console.error('api is unauthorized.', error) },
};
